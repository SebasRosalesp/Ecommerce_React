...
export const MakersSocialMediaIcons9 = ({ className }) => {
  return (
    <svg
      className={`makers-social-media-icons-9 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_223)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_223">
