...
export const LogoGithub = ({ className }) => {
  return (
    <svg
      className={`logo-github ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_140)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_140">
          <rect className="rect" fill="white" height="24" transform="translate(1)" width="22" />
        </clipPath>
      </defs>
    </svg>
  );
